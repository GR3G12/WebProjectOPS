<header class="custom-header">
    <a class="logo" href="#">
        <!-- <img src="imgs/actscc-logo.png" alt="School Logo" style="height: 35px; margin-right: 10px; margin-left:20px"> -->
    ...
    <div class="profile-image">
        ...
        <?php else: ?>
            <img src="../img/profile-default-G.png" alt="Default Profile Image" ><!-- width="50px" height="50px" -->
        <?php endif; ?>
        <!-- <h4><?php echo htmlspecialchars($firstname); ?></h4>
        <h4><?php echo htmlspecialchars($lastname); ?></h4> -->
        <h4>
            <?php
