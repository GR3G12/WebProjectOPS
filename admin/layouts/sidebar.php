    ...
    <div class="top">
        ...
        <div class="sidebar-content">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a href="add_controller.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'add_controller.php' ? 'active' : ''; ?>">
                        <!-- <i class="fas fa-receipt fa-fw"></i>  -->
                        <img src="../../img/add-payment-Icon.png" alt="Add" width=29px">
                        <span>Payments</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="student_controller.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'student_controller.php' ? 'active' : ''; ?>">
                        ...
                        <span>Students</span> <!-- Users -->
                    </a>
                </li>
                
                <li class="nav-item">
                    <a href="users_controller.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'users_controller.php' ? 'active' : ''; ?>">
                        <!-- <i class="fas fa-sign-out-alt fa-fw"></i>  -->
                        <img src="../imgs/user-setting.png" alt="Logout" width=29px">
                        <span>Users</span>
                    </a> 
                </li>  
            </ul>
...
<script>
 ...
 <div id="logoutModal" class="confirmation-logout-modall">
    <div class="confirmation-logout-modall-content">
        <div class="par">
...
<style>
    ...
    /* Modal Content */
    .confirmation-logout-modall-content {
    ...
    .confirmation-logout-modall-content .par{
    ...
    /* Buttons */
    .confirmation-logout-modall-content .modal-buttons {
        margin-top: 20px;
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    .confirmation-logout-modall-content .btn-confirm {
        height: 35px;
        width: 120px;
        font-size: 17px;
    ...
    .confirmation-logout-modall-content .btn-cancel {
        height: 35px;
        width: 120px;
        font-size: 17px;
    ...
    .confirmation-logout-modall-content .btn-confirm:hover {
        height: 32px;
        width: 100px;
        font-size: 15px;
        background-color: #ba1300;
    ...
    .confirmation-logout-modall-content .btn-cancel:hover {
        height: 32px;
        width: 100px;
        font-size: 15px;
        background-color: #0165bc;
